<template>
  <div class="question">
    ...
    <div class="question-answer" style="display: flex; justify-content: space-around; align-item: center">
      <div class="selected-answer" @click="selectedDogMbti({idx: 7, answer: 1});" style="cursor:pointer;">
        <h3>미련한 곰</h3>
        <img src="@/assets/survey/1-1.png" alt="">
      </div>
      <div class="selected-answer" @click="selectedDogMbti({idx: 7, answer: -1});" style="border: solid black; cursor:pointer">
        <h3>눈치빠른 여우</h3>
