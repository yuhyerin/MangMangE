<template>
  <div class="question">
    ...
    <div class="question-answer" style="display: flex; justify-content: space-around; align-item: center">
      <div class="selected-answer" @click="selectedDogMbti({idx: 4, answer: 1});" style="cursor:pointer;">
        <h3>얌전히 기다린다</h3>
        <img src="@/assets/survey/1-1.png" alt="">
      </div>
      <div class="selected-answer" @click="selectedDogMbti({idx: 4, answer: -1});" style="border: solid black; cursor:pointer">
