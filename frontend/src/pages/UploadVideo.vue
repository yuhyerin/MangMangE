<template>
  <div style="padding-top: 75px" >
    ...
    >
      ...
      <p v-if="desertionNoCheck==1" style="color: orange; margin-left: 70px;">일련번호는 15자입니다.</p>
      <p v-else-if="desertionNoCheck==2" style="color: red; margin-left: 70px;">존재하지 않는 일련번호입니다.</p>
      
      <div style="display: flex; margin-top: 35px; height: 60px;">
        <v-text-field
          placeholder="제목"
          v-model="title"
          outlined
